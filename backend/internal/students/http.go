...
func (h *Handler) Resource(w http.ResponseWriter, r *http.Request) {
	...
	if len(segments) == 0 {
		httpapi.WriteError(w, http.StatusNotFound, "student not found")
		return
	}
...
func (h *Handler) list(w http.ResponseWriter, r *http.Request) {
	...
	httpapi.WriteJSON(w, http.StatusOK, students)
}
...
func (h *Handler) create(w http.ResponseWriter, r *http.Request) {
	...
	writeStudentResult(w, http.StatusCreated, student, err)
}
...
func (h *Handler) update(w http.ResponseWriter, r *http.Request, id string) {
	...
	student, err := h.service.Update(r.Context(), id, input)
	writeStudentResult(w, http.StatusOK, student, err)
}
...
func (h *Handler) setStatus(w http.ResponseWriter, r *http.Request, id string) {
	...
	student, err := h.service.SetStatus(r.Context(), id, input)
	writeStudentResult(w, http.StatusOK, student, err)
}

func writeStudentResult(w http.ResponseWriter, successStatus int, student Student, err error) {
	switch {
	case err == nil:
		httpapi.WriteJSON(w, successStatus, student)
...
func resourceSegments(path string) []string {
	resource := strings.TrimPrefix(path, "/students/")
